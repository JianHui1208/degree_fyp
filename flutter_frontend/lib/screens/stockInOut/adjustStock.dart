      ...
      for (var i = 0; i < modifiedItems.length; i++) {
        stockHistoryItems.add(
          StockHistoryItem(
            ...
            newQuantity: modifiedItems[i].currentAddQuantity,
            currentAddQuantity: modifiedItems[i].currentAddQuantity -
                modifiedItems[i].oldQuantity,
          ),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Container(
              ...
              child: const Text(
                'Adjust Record Added Successfully',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 18,
                ),
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return const ErrorBox(
                message: 'Adjust Record Save Failed',
                content:
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    return ListTile(
                                      ...
                                      trailing: Text(
                                        'New Quantity: ${modifiedItems[index].currentAddQuantity.toString()}',
